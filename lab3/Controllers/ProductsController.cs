...
namespace lab3.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var adventureWorks2014Context = _context.Product.Include(p => p.ProductModel).Include(p => p.ProductSubcategory).Include(p => p.SizeUnitMeasureCodeNavigation).Include(p => p.WeightUnitMeasureCodeNavigation);
